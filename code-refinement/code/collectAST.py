...
load_model_path = 'saved_models/model_CT.bin'
model.load_state_dict(torch.load(load_model_path))
model.to(device)

files=[]
# test_filename = '../data/test.java-cs.txt.java,../data/test.java-cs.txt.cs'
test_filename = '/home/fjiriges/ordering/code-refinement/data/medium/test.buggy-fixed.buggy,/home/fjiriges/ordering/code-refinement/data/medium/test.buggy-fixed.fixed'
...
with open('CT4CR_AST_attention_weights.pkl', 'wb') as f:
